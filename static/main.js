...
function $s_Lexample_Hello__main__AT__V(args) {
  var this$1 = $m_Lexample_Hello$();
  var x = this$1.greeting__T();
...
function $p_Lexample_Hello$__greeting$lzycompute__T($thiz) {
  if ((!$thiz.Lexample_Hello$__f_bitmap$0)) {
    $thiz.Lexample_Hello$__f_greeting = "hello from js";
    $thiz.Lexample_Hello$__f_bitmap$0 = true
  };
  return $thiz.Lexample_Hello$__f_greeting
}
/** @constructor */
function $c_Lexample_Hello$() {
  this.Lexample_Hello$__f_greeting = null;
  this.Lexample_Hello$__f_bitmap$0 = false
}
...
$c_Lexample_Hello$.prototype.greeting__T = (function() {
  return ((!this.Lexample_Hello$__f_bitmap$0) ? $p_Lexample_Hello$__greeting$lzycompute__T(this) : this.Lexample_Hello$__f_greeting)
});
